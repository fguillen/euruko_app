...
...connected to Yahoo API
    ...
    formatted_update_status_paper PUT    /papers/:id/update_status.:format           {:controller=>"papers", :action=>"update_status"}
        ...
        formatted_notificate_cart POST   /pay/:id/notificate.:format                 {:controller=>"carts", :action=>"notificate"}
          ...
          yahoo_geoplanet_searchs POST   /yahoo_geoplanet_searchs                    {:controller=>"yahoo_geoplanet_searchs", :action=>"create"}
formatted_yahoo_geoplanet_searchs POST   /yahoo_geoplanet_searchs.:format            {:controller=>"yahoo_geoplanet_searchs", :action=>"create"}
